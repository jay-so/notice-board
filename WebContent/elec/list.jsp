...
<caption><h2 align="center"><b>개인 리스트 및 가계부 LIST</b></h2></caption>
	<colgroup>
		<col width="15%"/>
		<col width="30%"/>
		<col width="16%"/>
	...
	<tr>
        ...
        <td bgcolor="#00cc00">
            <p align="center"><font color="white"><b><span style="font-size:9pt;">확인 횟수</span></b></font></p>
        </td>
    </tr>
    ...
    <c:when test="${empty requestScope.list}">
	   <tr>
        <td colspan="5">
            <p align="center"><b><span style="font-size:9pt;">등록된 내용이 없습니다.</span></b></p>
        </td>
    </tr>
    </c:when>
    <c:otherwise>
